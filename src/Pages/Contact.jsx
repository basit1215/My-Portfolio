...
function Contact() {
  ...
  const sendDataToDB = async () => {
    setBtn(
      <div className="animate-spin border-4 border-blue-500 border-t-transparent rounded-full h-5 w-5"></div>
    );
  ...
  return (
    <>
      <section className="flex contact justify-center bg-[#252c41] items-center py-10">
        <div
          className="w-full max-w-[45rem] bg-[#031540] mt-[82px] shadow-[#00abf0] shadow-[0_0_22px_var(--main-color)] rounded-lg p-6"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          <h1
            className="text-3xl mb-8 text-[#00abf0] text-center font-bold"
            data-aos="fade-down"
            data-aos-delay="400"
          >
            GET IN TOUCH
          ...
          <p
            ...
            data-aos-delay="600"
          >
            I would like to know the final requirements of your project. Please
            get in touch with me and share details about your project.
          </p>
          <div className="mt-5">
            <input
              placeholder="Name"
            ...
            <div className="text-center mt-5">
              <button
                ...
                className="inline-block px-6 py-2 bg-blue-500 text-[#0e1b38] font-bold text-base rounded-[5%] border border-transparent duration-300 ease-in-out transition transform hover:bg-blue-500 hover:shadow-none shadow-[0_0_13px_var(--main-color)] shadow-[#00abf0]"
              >
                {btn}
              </button>
